            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Vivek</span>
                    </a>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 w-[80%]">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="mt-1 block w-full focus:outline-none focus:ring-green-500 focus:border-green-500"
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className="mt-1 block w-full focus:outline-none focus:ring-indigo-500 focus:border-green-500"
                                />
                                <span className="text-gray-700">${formData.maxPrice}</span>
                            </div>
                            <button
                                type="submit"
                                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                            >
                                Submit
                            </button>
                        </form>
            ...
            <div className='h-72 m-5 flex gap-2'>
                {Pdata.map((data) => (
                    <div class="w-1/6 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <a href={`/${data.productName}`} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-800  dark:bg-red-600">
                            Read more
